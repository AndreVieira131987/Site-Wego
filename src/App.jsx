  ...
  */
  ...
  return (
    <div className="antialiased selection:bg-primary selection:text-dark relative min-h-screen bg-dark w-full">
      ...
      {/* Navigation */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 w-full px-6 md:px-12 flex justify-between items-center transition-all duration-300 ${scrolled ? "py-4 bg-dark/85 backdrop-blur-md border-b border-light/5 shadow-lg" : "py-6"
          }`}
      >
      ...
      <div className={`fixed inset-0 z-40 bg-dark/98 backdrop-blur-2xl transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] flex flex-col pt-32 px-6 pb-8 md:hidden ${mobileMenuOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <div className="mt-auto pt-10">
          <a href="https://wa.me/5541998541669" target="_blank" rel="noopener noreferrer" onClick={() => setMobileMenuOpen(false)} className="block w-full text-center bg-primary text-dark font-bold text-lg py-5 rounded-2xl shadow-[0_4px_24px_rgba(4,243,251,0.3)]">
            Falar com Especialista
          </a>
        </div>
      </div>
      ...
      <section ref={sectionRef} className="relative h-[200vh] w-full z-10 bg-dark">
        ...
        <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center px-6 overflow-hidden text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-btn-intro w-full max-w-2xl px-4 mb-24">
            <a
              href="https://wa.me/5541998541669"
              ...
              >
                ...
                <div className="flex flex-col lg:flex-row items-center gap-6">
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group relative isolate overflow-hidden bg-secondary text-offwhite font-black px-10 py-5 rounded-2xl shadow-[0_8px_30px_rgba(13,98,127,0.3)] transition-all duration-500 w-full md:w-auto inline-block text-center"
                  >
      ...
      <footer className="relative py-12 bg-[#0a0d14] z-10 border-t border-light/5 text-center">
        <div className="max-w-4xl mx-auto px-6 flex flex-col items-center justify-center gap-6">
          ...
          <div className="text-light/70 font-sans text-sm leading-relaxed mb-4">
            ...
            <p>Centro - Curitiba PR - CEP: 80010-100</p>
          </div>
